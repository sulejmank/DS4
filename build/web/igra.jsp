...
<html>
	<head>
        ...
        <%  
            ...
            String trazena = igra.izaberiRec();
             
           // igra.trazenaRec = trazena;
            
            //igra.initializeTrenutniPokusaj();
            
            String trenutniPokusaj = request.getParameter("guess");
            char pokusaj = trenutniPokusaj.charAt(0);
             
           // igra.pogodak(pokusaj);
             
           // String trenutno_stanje = igra.getCurrentGuess();
